...
import { Search, Filter, MapPin, Calendar, Users, Compass, Camera, Utensils, } from 'lucide-react'
...
const featuredDestinations = [
  { id: 1, name: 'Bali', image: '/placeholder.svg?height=400&width=600', description: 'Island paradise', category: 'Relaxation', price: 1200, duration: 7, rating: 4.8 },
  { id: 2, name: 'Tokyo', image: '/placeholder.svg?height=400&width=600', description: 'Urban adventure', category: 'Cultural', price: 1800, duration: 5, rating: 4.9 },
  { id: 3, name: 'Machu Picchu', image: '/placeholder.svg?height=400&width=600', description: 'Ancient wonder', category: 'Adventure', price: 1500, duration: 6, rating: 4.7 },
  { id: 4, name: 'Paris', image: '/placeholder.svg?height=400&width=600', description: 'City of lights', category: 'Culinary', price: 2000, duration: 6, rating: 4.6 },
  { id: 5, name: 'Great Barrier Reef', image: '/placeholder.svg?height=400&width=600', description: 'Underwater marvel', category: 'Adventure', price: 2200, duration: 8, rating: 4.8 },
  { id: 6, name: 'Rome', image: '/placeholder.svg?height=400&width=600', description: 'Eternal city', category: 'Cultural', price: 1700, duration: 5, rating: 4.7 },
]

export default function Explore() {
  const [showMap, setShowMap] = useState(false)
  const [showFilters, setShowFilters] = useState(false)
  const [filteredDestinations, setFilteredDestinations] = useState(featuredDestinations)
    ...
    <Layout>
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold mb-8 text-center text-gray-800">Explore Destinations</h1>
    ...
    {showMap && <InteractiveMap />}
          <div className="flex">
            ...
            <div className="flex-grow">
              <div className="mb-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {categories.map((category) => (
                    <Link key={category.name} href={`/explore/category/${category.name.toLowerCase()}`} className="bg-white rounded-lg p-4 text-center hover:bg-turquoise-100 transition-colors">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4 text-gray-800">Featured Destinations</h2>
      ...
      <section className="py-12 bg-turquoise-100">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">Plan Your Next Adventure</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600">Explore our curated list of destinations and find your perfect match.</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <Calendar className="h-12 w-12 text-purple-500 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Set Your Dates</h3>
              <p className="text-gray-600">Find the best time to visit and plan your itinerary accordingly.</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <Users className="h-12 w-12 text-turquoise-500 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Customize Your Experience</h3>
              <p className="text-gray-600">Tailor your trip to your preferences and travel style.</p>
            </div>
          </div>
        </div>
      </section>
