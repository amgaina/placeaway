      ...
      <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="bg-blue-600 rounded-xl shadow-lg p-8 text-white text-center">
            ...
            <div>
              <Link
                href={`/booking/${destination.name.toLowerCase().replace(/[\s,]+/g, '_')}`}
                className="bg-white text-blue-600 font-bold py-3 px-6 rounded-full text-lg hover:bg-blue-50 transition duration-300"
              >
                Plan My Trip
              </Link>
            </div>
