  ...
  return (
    <section className="relative py-16 bg-gradient-to-br from-teal-50 to-blue-50 overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">Understanding Your Booking</h2>
          ...
          <div className="relative z-10">
            <div className="flex items-start mb-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                At TripZen, we strive to provide you with the best travel experience. Our services include both advisory assistance and direct bookings. Please note that refund policies may vary depending on the type of service or package you choose.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-amber-50 rounded-lg p-6">
                <h3 className="text-xl font-semibold mb-4 text-amber-700">TripZen Packages</h3>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-semibold mb-4 text-gray-700">External Bookings</h3>
                <ul className="space-y-3">
                  {[
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600">
                For detailed information about booking terms and refund policies, please refer to our{' '}
